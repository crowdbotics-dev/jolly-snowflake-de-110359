...
## Project Structure
    ...
    ├── jolly_snowflake_de_110359  # Django project configurations
...
1. Clone this repo and `cd jolly_snowflake_de_110359`
...
2. Clone this repo and `cd jolly_snowflake_de_110359`
